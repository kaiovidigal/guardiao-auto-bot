...
# ========= HÍBRIDO (curta/longa) =========
SHORT_WINDOW   = 400      # cauda curta (sensível ao momento)
LONG_WINDOW    = 5000     # cauda longa (estável)
CONF_SHORT_MIN = 0.60     # mínimo de confiança no modelo curto
CONF_LONG_MIN  = 0.65     # mínimo de confiança no modelo longo
