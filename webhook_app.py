...
# ========= HÍBRIDO (curta/longa) =========
SHORT_WINDOW   = 500      # cauda curta (sensível ao momento)
LONG_WINDOW    = 3000     # cauda longa (estável)
CONF_SHORT_MIN = 0.49     # mínimo de confiança no modelo curto
CONF_LONG_MIN  = 0.55     # mínimo de confiança no modelo longo
GAP_MIN        = 0.040    # distância top1-top2 mínima (anti-empate)
